...
export default function AdminSecurityPage() {
  ...
  async function handleCopyPublicLink() {
    ...
    try {
      ...
      setQrFeedback("Nao foi possivel copiar automaticamente. Copie manualmente o link.");
    }
  }
  ...
  function handlePrintPamphlet() {
    ...
    if (!printWindow) {
      setQrFeedback("Nao foi possivel abrir a janela de impressao.");
      return;
    }
...
<body>
  <div class="wrap">
    <h1>TopCell - Consulta de Ordem de Servico</h1>
    <p>Escaneie o QR Code para consultar sua OS, acompanhar status e aprovar/cancelar servico quando solicitado.</p>
    ...
    <div class="box">
      ...
      <ol class="steps">
        ...
        <li>Informe nome, telefone e numero da OS.</li>
        <li>Acompanhe o status e confirme o servico quando estiver em aguardando aprovacao.</li>
      </ol>
          ...
          <div className="grid gap-4 md:grid-cols-[300px_1fr]">
            ...
            <div className="space-y-3">
              <div className="space-y-1">
                <Label htmlFor="consultaOsLink">Link publico da consulta</Label>
              ...
              <div className="rounded-xl border border-dashed border-white/20 bg-slate-900/60 p-3 text-xs text-blue-100/70">
                Dica: entregue ao cliente o numero da OS junto do comprovante para facilitar a consulta.
              </div>
            </div>
          </div>
        </CardContent>
