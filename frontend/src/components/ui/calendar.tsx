...
function Calendar({ className, classNames, showOutsideDays = true, ...props }: CalendarProps) {
  return (
    <DayPicker
      ...
      className={cn("p-1 sm:p-3 w-full max-w-full overflow-hidden", className)}
      classNames={{
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-7 w-7 sm:h-9 sm:w-9 p-0 font-normal aria-selected:opacity-100"),
